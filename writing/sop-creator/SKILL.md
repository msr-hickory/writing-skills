...
**Always apply the personal-writing skill underneath this skill.** The personal-writing rules (voice, banned words, rhythm, anti-AI patterns) are the base layer. This skill adds operational documentation structure (Definition of Done, specificity rules, format selection, anti-patterns) on top.
...
- [ ] **Banned word check**: Run against the personal-writing skill's banned list
...
Adapted from:
- **coleam00/second-brain-skills** — SOP-creator skill (original structure, philosophy, anti-patterns)
- **Cathy Moore** (*Map It*) — Action mapping applied to documentation
- **FDA/ISO SOP standards** — 3Cs (Clarity, Consistency, Conciseness)
